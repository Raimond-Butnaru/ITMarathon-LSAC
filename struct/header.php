...
<head>
	<meta charset="UTF-8">
	<title>IT Marathon 2021 || LSAC Iasi</title>
	...
	<meta property="og:description"        content="În 2018 Liga Studenților Facultății de Automatică și Calculatoare organizează competiţia ‘’IT Marathon’’, eveniment ce se adresează tuturor studenţilor şi elevilor pasionaţi de tehnologie din toată țara.Concursul, aflat la a VI-a ediție, a crescut în fiecare an ca număr de participanți și ca număr de secțiuni, anul acesta fiind extins la nivel naţional. Aceasta cuprinde o serie de prezentări, provocări și concursuri ce vizează diferite domenii din sfera IT prin intermediul cărora se vor evidenția abilități, aptitudini, respectiv dezvoltarea personală ale participanților">
	...
	<link rel="icon" type="image/png" href="images/favicon/logo.png" sizes="32x32">
	<link rel="icon" type="image/png" href="images/favicon/logo.png" sizes="16x16">
    ...
    <section class="theme_menu stricky">
            <div class="menu-row">
                ...
                <div class="link_btn right-column btn-desktop">
                    <a href="#" class="thm-btn" target=_blank>Înscrie-te acum!</a>
                </div>
